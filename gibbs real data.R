...
setwd('U:/independent studies/kaplan amazon hydrology/gibbs')
y=data.matrix(read.csv('data for gibbs.csv',as.is=T))
image(y)
...
#output results
setwd('U:\\independent studies\\kaplan amazon hydrology\\gibbs\\results mvnorm.gap')
